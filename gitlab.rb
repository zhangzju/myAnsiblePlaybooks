...
external_url 'https://spcodes.rd.tp-link.net'
...
gitlab_rails['webhook_timeout'] = 600
...
#         uid: 'sAMAccountName'
         ...
         bind_dn: 'uid=spbu.ci,ou=admin,ou=system,dc=tp-link,dc=net'
         password: 'hh7z1ktO'
         active_directory: false
         allow_username_or_email_login: true
#         allow_username_or_email_login: false
         block_auto_created_users: false
         base: 'dc=tp-link,dc=net'
#         user_filter: 'objectClass=TPUserAccount'
#         user_filter: ''
         attributes:
              username: ['uid']
              email:    ['email']
...
# DEPRECATED: gitlab_rails['satellites_timeout'] = 10
...
# Use smtp instead of sendmail/postfix.
 ...
 gitlab_rails['smtp_address'] = "mail.tp-link.com.cn"
 gitlab_rails['smtp_port'] = 25
 gitlab_rails['smtp_user_name'] = "spbu.ci@tp-link.com.cn"
 gitlab_rails['smtp_password'] = "hh7z1ktO"
...
# redis['uid'] = nil
# redis['gid'] = nil
redis['tcp_timeout'] = "600"
redis['tcp_keepalive'] = "600"
...
nginx['ssl_certificate'] = "/etc/gitlab/ssl/git_ssl.crt"
nginx['ssl_certificate_key'] = "/etc/gitlab/ssl/git_ssl.key"
...
nginx['proxy_read_timeout'] = 36000
nginx['proxy_connect_timeout'] = 3000
